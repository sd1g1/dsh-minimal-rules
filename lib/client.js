window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function RulesModeSlot({ sessionId, useSessions }) {
      const agentPreset = useSessions((state) => sessionId != null ? state.byId[sessionId]?.agentPreset : undefined);
      if (agentPreset !== "minimal" && agentPreset !== "minimal-fast") return null;
      return jsx.jsx(RulesModeSelect, {});
    }
